...
class FreeTrialPage:
    ...
    checkbox_terms = (By.XPATH, "//input[@id='page-233cu-gdpr-consent-checkbox']")
    ...
    def get_error_message_text(self):
        webdriver_wait(driver=self.driver, element_tuple=self.error_msg_invalid_email, timeout=10)
